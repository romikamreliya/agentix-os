# Visual System Selection (Phase 5)

Choose each element to match the **Phase 1 preferences**, **Phase 2 audience**,
and the **Phase 4 trend findings**. State the rationale for every choice. Accessibility (WCAG AA contrast, target
...
tying it to a preference, goal, or trend finding. This feeds directly into
Phase 6.
</content>
